...
@section('breadcrumbs')
	<ol class="breadcrumb" style="margin-bottom: 5px;">
		...
		<li class="active">@lang('front/general.edit_ad')</li>
	</ol>
@stop
...
@section('content')
    <div class="wrapper nearme-item">
		<hr>
		<div class="welcome">
			<h1>@lang('front/general.edit_ad')</h1>
		</div>
		<hr>
        <div class="content">
           ...
           <div class="has-error">
            ...
            {!! Form::model($ad, array('url' => URL::to('ad/'.$ad->id.'/edit'), 'method' => 'post', 'id' => 'ad', 'class' => 'bf', 'files'=> true)) !!}
                    ...
                    <div class="col-sm-12">
								...
								<div class="col-md-12">
									<div class="fileinput fileinput-new" data-provides="fileinput">
										<div class="fileinput-new thumbnail" style="max-width: 200px; max-height: 150px;">
											@if($ad->image)
												<img src="{{ asset('uploads/ads/'.$ad->image) }}" class="img-responsive" />
											@else
											@endif
										</div>
						...
						@if(TemplateHelper::isDeveloper())
							<div class="form-group">
								...
								{!! Form::YesNo('recurring', $ad->recurring) !!}
							</div>
						@endif
						*/ ?>
							...
							<div class="form-group recurring {{ $errors->first('recurring', 'has-error') }}">
								<div class="row">
									<div class="col-md-12 recurring-box">
										<label>{!! Form::checkbox('recurring', 1, true) !!} @lang('ads/form.recurring_checkbox', ['default' => Lang::get('classified/form.renewal_every_2_weeks')])</label>
						...
						<div class="form-group">
							...
							@if($ad->recurring == 1 && $ad->paid == 1)
								@if(!empty($ad->vault_id))
									<a href="{{ route('updatevault', ['vault_id' => $ad->vault_id]) }}" class="btn btn-success">Update Credit Card details</a>
								@endif
							@endif
