...
<section class="content-header">
    <!--section starts-->
    <h1>@lang('adrenewoption/title.add-ad-renew-option')</h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li class="active">@lang('adrenewoption/title.add-ad-renew-option')</li>
    </ol>
</section>
<!--section ends-->
<section class="content paddingleft_right15">
    ...
    {!! Form::open(array('url' => URL::to('admin/adrenewoption/create'), 'method' => 'post', 'class' => 'bf form-horizontal')) !!}
    <div class="row">
        <div class="container">
