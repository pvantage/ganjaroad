        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
				<div class="panel-heading clearfix">
					<form action="{{ route('sales/reps/info', $user->id) }}">
						<div class="row">
							...
							<div class="pull-right">
								...
								<a href="{{ route('sales/reps/info', $user->id) }}" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-remove"></i>@lang('sales/title.remove_filters')</a>
							</div>
						</div>
...
function exportResult(type)
{
	$.ajax({
		type: 'GET', 
		url: '{!! route('sales.reps.info.print', $user->id) !!}', 
