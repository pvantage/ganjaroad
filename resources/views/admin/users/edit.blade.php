...
<section class="content-header">
    <h1>@lang('users/form.edit_user')</h1>
    <ol class="breadcrumb">
        <li>
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"> <i class="livicon" data-name="users" data-size="16" data-c="#fff" data-hc="#fff" data-loop="true"></i>
                        @lang('users/form.editing_user') : {!! $user->first_name!!} {!! $user->last_name!!} (@lang('users/form.edit_user_id', ['uid' => $user->id]))
                    </h3>
                </div>
                                ...
                                <div id="rootwizard">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane" id="tab1">
                                            ...
                                            <div class="form-group">
                                                <p class="text-warning">@lang('users/form.user_password_notice')</p>
											...
											<div class="user-group-wrapper">
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input id="published" name="published" type="checkbox" class="pos-rel p-l-30" value="1" @if($user->published || $user->published) checked="checked" @endif  >
													<span>@lang('users/form.published-checkbox')</span>
													</div>
												</div>
                                                <div class="form-group">
													...
													<div class="col-sm-10">
														<input id="newsletter" name="newsletter" type="checkbox"
															   ...
															   value="1" @if(old('news') || $user->news) checked="checked" @endif />
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input id="newsletter" name="newsletter" type="checkbox"
															   class="pos-rel p-l-30"
															   value="1" @if(old('newsletter') || $user->newsletter) checked="checked" @endif disabled readonly />
													<span>@lang('users/form.newsletter_notice')</span></div>
												</div>
												
												<div class="form-group">
													<label for="spammer" class="col-sm-2 control-label"> @lang('users/form.spammer')</label>
													<div class="col-sm-10">
														<input id="spammer" name="spammer" type="checkbox"
															   class="pos-rel p-l-30"
															   value="1" @if(old('spammer') || $user->spammer) checked="checked" @endif />
													<span>@lang('users/form.spammer-checkbox')</span></div>
												</div>
											</div>
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 200px;">
                                                            @if($user->pic)
                                                                <img src="{!! url('/').'/uploads/users/'.$user->pic !!}" alt="@lang('users/form.profile_picture')">
                                                            @else
                                                                <img src="http://placehold.it/200x200" alt="@lang('users/form.profile_picture')">
                                                            @endif
                                                        </div>
                                                    ...
                                                    <span class="btn btn-default btn-file">
                                                        ...
                                                        <input id="pic" name="pic_file" type="file"
                                                            ...
                                                            <a href="#" class="btn btn-default fileinput-exists" data-dismiss="fileinput" style="color: black !important;">@lang('users/form.remove')</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane" id="tab3" disabled="disabled">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <select class="form-control" title="@lang('users/form.select_gender')" name="gender">
                                                        <option value="">@lang('users/form.select')</option>
                                                        <option value="male" @if($user->gender === 'male') selected="selected" @endif >@lang('users/form.male')</option>
                                                        <option value="female" @if($user->gender === 'female') selected="selected" @endif >@lang('users/form.female')</option>
                                                        <option value="other" @if($user->gender === 'other') selected="selected" @endif >@lang('users/form.other')</option>
                                            ...
                                            <div class="form-group required">
                                                ...
                                                <div class="col-sm-10">
													{!! Form::SelectCountry('country', '', old('country',$user->country), array('class' => 'form-control select2', 'placeholder'=>trans('nearme/form.select-state'))) !!}
                                                </div>
                                            </div>
                                        ...
                                        <ul class="pager wizard">
                                            ...
                                            <li class="next finish"><a href="javascript:void(0);">@lang('users/form.finish')</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </form>
